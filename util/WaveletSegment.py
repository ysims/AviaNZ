...
import util.WaveletFunctions as WaveletFunctions
import util.SignalProc as SignalProc
import util.Segment as Segment
from util.ext import ce_denoise as ce
from util.ext import ce_detect
    ...
    def preprocess(self, data, sampleRate, fsOut, d=False, fastRes=False):
        ...
        if sampleRate != fsOut:
            if not fastRes:
                ...
                data = librosa.resample(
                    data, orig_sr=sampleRate, target_sr=fsOut, res_type="kaiser_fast"
                )
